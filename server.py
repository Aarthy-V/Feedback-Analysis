...
def do_admin_login():
    if request.form['password'] == 'admin' and request.form['username'] == 'admin':
        ...
        session['logged_in'] = True
        return hoddashboard()
    elif request.form['password'] == 'lecturer1' and request.form['username'] == 'lecturer1':
        session['logged_in'] = True
        return teacherdashboard(1)
    elif request.form['password'] == 'lecturer' and request.form['username'] == 'lecturer2':
        session['logged_in'] = True
        return teacherdashboard(2)
    elif request.form['password'] == 'lecturer3' and request.form['username'] == 'lecturer3':
        session['logged_in'] = True
        return teacherdashboard(3)
    elif request.form['password'] == 'lecturer4' and request.form['username'] == 'lecturer4':
        session['logged_in'] = True
        return teacherdashboard(4)
    elif request.form['password'] == 'lecturer5' and request.form['username'] == 'lecturer5':
        session['logged_in'] = True
        return teacherdashboard(5)
    elif request.form['password'] == 'lecturer6' and request.form['username'] == 'lecturer6':
        session['logged_in'] = True
...
def teacherdashboard(teachernumber):
    ...
    if teachernumber == 1:
        return render_template('lecturerdashboard.html',ttf=ttf,ttp=ttp, ttn=ttn, ttneu=ttneu)
    elif teachernumber == 2:
        return render_template('lecturerdashboard.html',ttf=ttf,ttp=tcp, ttn=tcn, ttneu=tcneu)
    elif teachernumber == 3:
        return render_template('lecturerdashboard.html',ttf=ttf,ttp=tep, ttn=ten, ttneu=teneu)
    elif teachernumber == 4:
        return render_template('lecturerdashboard.html',ttf=ttf,ttp=tlwp, ttn=tlwn, ttneu=tlwneu)
    elif teachernumber == 5:
        return render_template('lecturerdashboard.html',ttf=ttf,ttp=tlfp, ttn=tlfn, ttneu=tlfneu)
    else:
        return render_template('lecturerdashboard.html',ttf=ttf,ttp=tecp, ttn=tecn, ttneu=tecneu)
...
def displayteacherfeedbacks():
    if not session.get('logged_in'):
        ...
        return render_template('lecturerfeedbacks.html', tables=[df1.to_html(classes='data', header="true")])
